...
fun DaftarScreen(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Text(
            ...
            style = TextStyle(
                fontFamily = rubikfamily, fontWeight = FontWeight.Normal, fontSize = 14.sp
            )
        )
        ...
        OutlinedTextField(
            ...
            textStyle = TextStyle(
                color = Color(0xFF4A4863), fontSize = 16.sp
            ),
        ...
        Text(
            text = "Dengan memilih Buat Akun di bawah ini, saya setuju dengan Persyaratan Layanan & Kebijakan Privasi",
            fontFamily = rubikfamily, fontWeight = FontWeight.Normal, fontSize = 14.sp, color = Color.Black
        )
